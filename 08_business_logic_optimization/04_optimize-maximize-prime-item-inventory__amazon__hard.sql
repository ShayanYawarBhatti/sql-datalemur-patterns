...
-- Company: Amazon
-- Difficulty: Hard
-- Pattern: closed-form capacity allocation
-- Summary: Maximize prime-eligible batches first, then use remaining area for non-prime batches.
-- Notes: FLOOR converts available area into complete batches; the query does not enumerate allocations.
